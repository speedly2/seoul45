...
/*
 * 실제 업무에서 추상 클래스를 사용하는 이유는 공통 기능을 모듈화하고 코드의 재사용성을 높이며, 템플릿 메서드 패턴 구현과 타입의 일관성을 유지하기 위해서
		추상클래스 
		...
		인터페이스는 implements 라는 키워드처럼 인터페이스에 정의된 메소드를 각 클래스의 목적에 맞게 기능을 구현하는 느낌
 */
